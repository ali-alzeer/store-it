...
namespace storeitbackend.Migrations
{
    ...
    [Migration("20250603210941_TryAddConstraintGenerateGuidStringDataAnnotations")]
    partial class TryAddConstraintGenerateGuidStringDataAnnotations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("storeitbackend.Models.FileType", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValueSql("CAST(NEWID() AS VARCHAR(256))");
